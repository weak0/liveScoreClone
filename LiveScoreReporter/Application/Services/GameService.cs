    ...
    public class GameService : IGameService
    {
        ...
        public GameDetailsDto MapToGameDetailsDto(Game game, Lineup homeTeamLineup, Lineup awayTeamLineup, List<Event> gameEvents)
        {
            return new GameDetailsDto
            {
                ...
                HomeTeamLineup = homeTeamLineup.Players.Select(p => new PlayerDto(p.Id, p.Name, p.Postition, p.Photo) ).ToList(),
                AwayTeamLineup = awayTeamLineup.Players.Select(p => new PlayerDto(p.Id, p.Name, p.Postition, p.Photo)).ToList(),
